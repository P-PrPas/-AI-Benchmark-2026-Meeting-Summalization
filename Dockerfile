...
ARG CAMNET_PIPELINE_MODE=rag
ARG CAMNET_LLM_ONLY_PROMPT_MODE=minimal

ENV CAMNET_MODEL_DIR=/model/weights \
    CAMNET_PIPELINE_MODE=${CAMNET_PIPELINE_MODE} \
    CAMNET_EMBED_MODEL_NAME=${EMBED_MODEL_NAME} \
    ...
    CAMNET_LLM_ONLY_PROMPT_MODE=${CAMNET_LLM_ONLY_PROMPT_MODE} \
    CAMNET_LLM_ONLY_MAX_SEQ_LEN=32768 \
    CAMNET_LLM_ONLY_MAX_NEW_TOKENS=384 \
    CAMNET_LLM_ONLY_BATCH_SIZE=1 \
    CAMNET_LLM_ONLY_MAX_DOC_CHARS=0 \
    CAMNET_LLM_ONLY_TEMPERATURE=0.0 \
    CAMNET_LLM_ONLY_TOP_P=1.0 \
    ...
    CAMNET_ENABLE_EVIDENCE_COMPRESSION=0 \
    CAMNET_ENABLE_FACT_ANSWER_REWRITE=0 \
    CAMNET_REF_SELECTION_TOP2_MIN=0.35 \
    CAMNET_REF_SELECTION_TOP3_MIN=0.30 \
    CAMNET_REF_SELECTION_FACT_MAX_GAP=0.08 \
    CAMNET_REF_SELECTION_AGG_MAX_GAP=0.12
