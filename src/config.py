...
ENABLE_EVIDENCE_SET_SELECTOR = os.environ.get("CAMNET_ENABLE_EVIDENCE_SET_SELECTOR", "0").strip() not in {
    "0",
    "false",
    "False",
}
EVIDENCE_SET_MODEL_PATH = os.environ.get("CAMNET_EVIDENCE_SET_MODEL_PATH")
EVIDENCE_SET_FACT_THRESHOLD = float(os.environ.get("CAMNET_EVIDENCE_SET_FACT_THRESHOLD", "0.55"))
EVIDENCE_SET_LIST_THRESHOLD = float(os.environ.get("CAMNET_EVIDENCE_SET_LIST_THRESHOLD", "0.50"))
EVIDENCE_SET_SYNTH_THRESHOLD = float(os.environ.get("CAMNET_EVIDENCE_SET_SYNTH_THRESHOLD", "0.50"))
EVIDENCE_SET_MAX_REFS_FACT = int(os.environ.get("CAMNET_EVIDENCE_SET_MAX_REFS_FACT", "2"))
EVIDENCE_SET_MAX_REFS_LIST = int(os.environ.get("CAMNET_EVIDENCE_SET_MAX_REFS_LIST", "3"))
EVIDENCE_SET_MAX_REFS_SYNTHESIS = int(os.environ.get("CAMNET_EVIDENCE_SET_MAX_REFS_SYNTHESIS", "3"))
ENABLE_EXPANDED_CANDIDATES = os.environ.get("CAMNET_ENABLE_EXPANDED_CANDIDATES", "0").strip() not in {
    "0",
    "false",
    "False",
}
EXPANDED_DENSE_TOP_K = int(os.environ.get("CAMNET_EXPANDED_DENSE_TOP_K", "30"))
EXPANDED_BM25_TOP_K = int(os.environ.get("CAMNET_EXPANDED_BM25_TOP_K", "30"))
EXPANDED_QUOTE_TOP_K = int(os.environ.get("CAMNET_EXPANDED_QUOTE_TOP_K", "20"))
ENABLE_SEMI_EXTRACTIVE_COMPOSER = os.environ.get("CAMNET_ENABLE_SEMI_EXTRACTIVE_COMPOSER", "0").strip() not in {
    "0",
    "false",
    "False",
}
